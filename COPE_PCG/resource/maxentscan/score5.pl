...
my %me2x5 = &makescorematrix('/lustre/user/chengsj/25_splice_site_prediction/fordownload/me2x5');
my %seq = &makesequencematrix('/lustre/user/chengsj/25_splice_site_prediction/fordownload/splicemodels/splice5sequences');
...
open (FILE,"<$inputfile") || die "can't open chengsj!\n";
